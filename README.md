# Dictionary for sme — smj

This repository contains source files for a dictionary from North Sámi to Lule Sámi. The content is licensed under the CC-BY-4.0 license.
